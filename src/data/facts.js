export const factsArray = [
  ...
  [
    ...
    'AROUND THE NEIGHBORHOOD: Virgin Hyperloop, HAUSER & WIRTH, ART SHARE L.A., DOVER STREET MARKET, WARNER MUSIC GROUP, HONEY, WEWORK, BESTIA, ROLLING GREENS, ANGEL CITY BREWERY',
  ],
];
